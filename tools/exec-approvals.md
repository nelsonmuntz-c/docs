...
- **gateway host** → `clawdia` process on the gateway machine
...
`~/.clawdia/exec-approvals.json` directly.

CLI: `clawdia approvals` supports gateway or node editing (see [Approvals CLI](/cli/approvals)).
