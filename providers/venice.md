---
summary: "Use Venice AI privacy-focused models in Clawdia"
read_when:
  - You want privacy-focused inference in Clawdia
...
Clawdia automatically discovers models from the Venice API when `VENICE_API_KEY` is set. If the API is unreachable, it falls back to a static catalog.
