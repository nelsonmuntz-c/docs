---
summary: "Use Qwen OAuth (free tier) in Clawdia"
read_when:
  - You want to use Qwen with Clawdia
...
```bash
clawdia models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Clawdia will sync credentials
