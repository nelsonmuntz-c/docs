---
summary: "Use MiniMax M2.1 in Clawdia"
read_when:
  - You want MiniMax models in Clawdia
...
Configure manually via `clawdia.json`:
...
- Use `clawdia models list` and `clawdia models set minimax/MiniMax-M2.1` to switch.
...
- Running `clawdia configure` and selecting **MiniMax M2.1**, or
