---
summary: "Model providers (LLMs) supported by Clawdia"
read_when:
...
Clawdia can use many LLM providers. Pick one, authenticate, then set the default
...
1) Authenticate with the provider (usually via `clawdia onboard`).
