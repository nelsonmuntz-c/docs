---
summary: "Use Synthetic's Anthropic-compatible API in Clawdia"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Clawdia registers it as the
...
Note: Clawdia's Anthropic client appends `/v1` to the base URL, so use
