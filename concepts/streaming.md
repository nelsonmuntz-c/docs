...
Clawdia has two separate “streaming” layers:
...
When block streaming is enabled, Clawdia can **merge consecutive block chunks**
...
When draft streaming is active, Clawdia disables block streaming for that reply to avoid double-streaming.
