...
service via the external `clawdia` CLI (no embedded runtime). This gives you
...
- The app installs a per‑user LaunchAgent labeled `com.clawdia.gateway`
