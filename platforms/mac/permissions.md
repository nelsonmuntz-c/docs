...
- Same path: run the app from a fixed location (for Clawdia, `dist/Clawdia.app`).
...
```bash
sudo tccutil reset Accessibility com.clawdia.mac
sudo tccutil reset ScreenCapture com.clawdia.mac
