---
summary: "Clawdia macOS release checklist (Sparkle feed, packaging, signing)"
read_when:
  - Cutting or validating a Clawdia macOS release
...
```
Generates HTML release notes from `CHANGELOG.md` (via [`scripts/changelog-to-html.sh`](https://github.com/nelsonmuntz-c/clawdia/blob/main/scripts/changelog-to-html.sh)) and embeds them in the appcast entry.
