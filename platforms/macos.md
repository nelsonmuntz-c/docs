---
summary: "Clawdia macOS companion app (menu bar + gateway broker)"
read_when:
...
The macOS app is the **menu‑bar companion** for Clawdia. It owns permissions,
...
- **Local** (default): the app attaches to a running local Gateway if present;
  otherwise it enables the launchd service via `clawdia gateway install`.
...
The app manages a per‑user LaunchAgent labeled `com.clawdia.gateway`
...
Tip: compare against `clawdia gateway discover --json` to see whether the
