---
summary: "How Clawdia sandboxing works: modes, scopes, workspace access, and images"
title: Sandboxing
...
Clawdia can run **tools inside Docker containers** to reduce blast radius.
...
- `"none"` (default): tools see a sandbox workspace under `~/.clawdia/sandboxes`.
...
Debugging:
- Use `clawdia sandbox explain` to inspect effective sandbox mode, tool policy, and fix-it config keys.
