...
read_when:
  - You want to place an outbound voice call from Clawdia
  - You are configuring or developing the voice-call plugin
---

# Voice Call (plugin)

Voice calls for Clawdia via a plugin. Supports outbound notifications and
...
- Use `clawdia voicecall ...` or the `voice_call` tool
...
```bash
clawdia plugins install ./extensions/voice-call
