...
read_when:
  - You are building a Clawdia plugin
  - You need to ship a plugin config schema or debug plugin validation errors
---
# Plugin manifest (clawdia.plugin.json)

Every plugin **must** ship a `clawdia.plugin.json` file in the **plugin root**.
Clawdia uses this manifest to validate configuration **without executing plugin
