---
summary: "Use Amazon Bedrock (Converse API) models with Clawdia"
read_when:
  - You want to use Amazon Bedrock models with Clawdia
  - You need AWS credential/region setup for model calls
---
# Amazon Bedrock

Clawdia can use **Amazon Bedrock** models via pi‑ai’s **Bedrock Converse**
...
If AWS credentials are detected, Clawdia can automatically discover Bedrock
...
When running Clawdia on an EC2 instance with an IAM role attached, the AWS SDK
will automatically use the instance metadata service (IMDS) for authentication.
However, Clawdia's credential detection currently only checks for environment
...
- Clawdia surfaces the credential source in this order: `AWS_BEARER_TOKEN_BEDROCK`,
