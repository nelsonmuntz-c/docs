...
Deploy Clawdia on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.app/new/template?template=https://github.com/vignesh07/clawdia-railway-template" target="_blank" rel="noreferrer">Deploy on Railway</a>
...
- `https://<your-railway-domain>/clawdia` — Control UI

## What you get

- Hosted Clawdia Gateway + Control UI
...
- `CLAWDIA_STATE_DIR=/data/.clawdia` (recommended)
- `CLAWDIA_WORKSPACE_DIR=/data/workspace` (recommended)
- `CLAWDIA_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your Clawdia state + workspace so you can migrate to another host without losing config or memory.
