...
- Install via CLI: `clawdia plugins install @clawdia/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `clawdia plugins install ./extensions/zalo`
   - From npm (if published): `clawdia plugins install @clawdia/zalo`
...
- Approve via:
  - `clawdia pairing list zalo`
  - `clawdia pairing approve zalo <CODE>`
...
- Example: `clawdia message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `clawdia channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `clawdia logs --follow`
